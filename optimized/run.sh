...
languages << Language.new("Nim Memoized", :optimized, "nim c -d:danger fib_mem.nim", "./fib_mem")
languages << Language.new("Nim Constant", :optimized, "nim c -d:danger fib_const.nim", "./fib_cont")
languages << Language.new("Nim Rewrite", :optimized, "nim c -d:danger fib_rewrite.nim", "./fib_rewrite")
